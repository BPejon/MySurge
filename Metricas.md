...
### O que é?
**Structure Quality** avalia a **semelhança geral da estrutura hierárquica** entre o artigo GT e o gerado, incluindo a relação entre títulos de seções, subsecções e conteúdo. É uma avaliação holística feita por um modelo LLM (OpenAI GPT-4) como juiz.
...
### O que é?
**BLEU** (Bilingual Evaluation Understudy) é uma métrica de precisão que mede a **fração de palavras/frases do texto gerado que aparecem no texto de referência**. É comumente usada em machine translation.
...
**Documento gerado**: 17 de abril de 2026  
**Versão**: 1.0  
